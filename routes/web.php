...
/// For Settings Route
Route::get('/settings/all', [SettingsController::class, 'AllSettings'])->name('all.settings');
Route::post('/settings/add', [SettingsController::class, 'StoreSettings'])->name('store.settings');
...
Route::get('/testmonial/edit/{id}', [TestmonialController::class, 'Edit']);
Route::post('/testmonial/update/{id}', [TestmonialController::class, 'Update']);
Route::get('/testmonial/delete/{id}', [TestmonialController::class, 'Delete']);
